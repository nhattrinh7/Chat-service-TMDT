...
export interface IConversationRepository {
  ...
  findByUserId(userId: string, cursorTimestamp?: Date, cursorId?: string, limit?: number): Promise<Conversation[]>
  findByShopId(shopId: string, cursorTimestamp?: Date, cursorId?: string, limit?: number): Promise<Conversation[]>
